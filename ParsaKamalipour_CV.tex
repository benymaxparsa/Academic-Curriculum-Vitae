...
\end{multicols}
	...
	\cventry{Sep 2018--Jun 2023}{B.S. Computer Engineering, Major Track: Software Engineering.}{\href{https://benymaxparsa.github.io/education/VRU}{Vali-e-Asr University of Rafsanjan \ExternalLink}}{Rafsanjan, Iran}{}{
		\begin{itemize}
			\item \textbf{CGPA:} 16.26/20 with 140 credits passed. \textbf{GPA of Specialized Courses:} 17.80/20
	...
	\begin{itemize}
		...
		\item Fahimeh Dabaghi-Zarandi, \textbf{Parsa Kamalipour}, "Community detection in complex network based on Vertex Cover algorithm." \textit{(In preparation)}, \href{https://benymaxparsa.github.io/publication/p2}{link.\ExternalLink}

	\end{itemize}
	
	\subsection{Conference papers}
	\begin{itemize}
		\item I. Hemati Moghadam, M. M. Afkhami, \textbf{P. Kamalipour}, and V. Zaytsev, "Extending refactoring detection to Kotlin: A dataset and comparative study," \textit{In Proceedings of the 31st IEEE International Conference on Software Analysis, Evolution and Reengineering (SANER 2024)}, IEEE, 2024. \href{https://benymaxparsa.github.io/publication/p3}{link.\ExternalLink}
		\item I. Hemati Moghadam, M. M. Afkhami, V. Zaytsev, \textbf{P. Kamalipour}, M. H. Ashoori and F. Ahmed, "Cross-Language Refactoring Detection: Bridging Gaps with Pre-trained Language Models," \textit{Submitted to The 40th IEEE International Conference on Software Maintenance and Evolution (ICSME 2024)}, IEEE, 2024. \href{https://benymaxparsa.github.io/publication/p4}{link.\ExternalLink}
...
%$\filledstar$ \textit{Several "Machine Learning for Software Refactoring" papers are being written to be submitted in upcoming conferences.}
	...
	\cventry{Aug 2023--Mar 2024}{FMT group - Faculty of EE, Math and CS, \href{https://www.utwente.nl/en/}{University of Twente \ExternalLink}}{
		\href{https://benymaxparsa.github.io/research/UT-RA}{Remote Research Assistant \ExternalLink}
...
\section{Honors and Awards}
	...
	\cventry{Spring 2022}{Vali-e-Asr University of Rafsanjan}{Ranked top 10 among undergraduate students of Computer Engineering}{}{Entrance Year of 2018}{}
